...
class PHPSpreadsheet
{
     ...
     */
    public static function GeneraExcel($nombre_hoja, $titulo_reporte, $columnas, $filas)
    {
        $totales = [];
        ...
        // Seleccionar celda A1, congelar en la fila 3 y aplicar filtro a las columnas
