                ...
                <div class="card-body">
                    <form class="" action="/Creditos/CambioSucursal/" method="GET">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <input class="form-control mr-sm-2" style="font-size: 24px;" autofocus type="number" id="Credito" name="Credito" placeholder="000000" aria-label="Search" value="<?= $credito; ?>">
                                <span id="availability1"></span>
                            </div>
                            <div class="col-md-4">
                ...
                <div class="row">
                    <div class="tile_count float-right col-sm-12" style="margin-bottom: 1px; margin-top: 1px">
                        <div class="col-md-3 col-sm-4  tile_stats_count">
                            <span class="count_top" style="font-size: 15px"><i class="fa fa-user"></i> Grupo</span>
                            <div class="count" style="font-size: 14px"><?= $Administracion['GRUPO']; ?></div>
                        </div>
                        <div class="col-md-1 col-sm-1  tile_stats_count">
                            <span class="count_top" style="font-size: 15px"><i class="fa fa-clock-o"></i> Ciclo</span>
                            <div class="count" style="font-size: 14px"><?= $Administracion['CICLO']; ?> </div>
                        </div>
                        <div class="col-md-1 col-sm-4  tile_stats_count">
                            <span class="count_top" style="font-size: 15px"><i></i> Prestamo</span>
                            <div class="count" style="font-size: 14px"> $ <?= number_format($Administracion['MONTO'], 2); ?></div>
                        </div>
                        <div class="col-md-1 col-sm-4  tile_stats_count">
                            <span class="count_top" style="font-size: 15px"><i></i> Situación</span>
                            <div class="count" style="font-size: 14px"><?= $Administracion['SITUACION']; ?></div>
                        </div>
                        <div class="col-md-1 col-sm-3  tile_stats_count">
                            <span class="count_top" style="font-size: 15px"><i></i> Sucursal</span>
                            <div class="count" style="font-size: 14px"><?= $Administracion['SUCURSAL']; ?></div>
                        </div>
                        <div class="col-md-3 col-sm-4  tile_stats_count">
                            <span class="count_top" style="font-size: 15px"><i></i> Ejecutivo</span>
                            <div class="count" style="font-size: 14px"><?= $Administracion['EJECUTIVO']; ?> </div>
                        </div>
                        <div class="col-md-2 col-sm-4  tile_stats_count">
                            <span class="count_top" style="font-size: 15px"><i></i> Acción</span>
                            <div class="count" style="font-size: 14px">
                                <button type="button" class="btn btn-success btn-circle" onclick="EditarSucursal('<?= $Administracion['ID_EJECUTIVO']; ?>');"><i class="fa fa-edit"></i></button>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <center>
                    <h4 class="modal-title" id="myModalLabel">Cambiar Crédito de Sucursal </h4>
                </center>
            </div>
            <div class="modal-body">
                <div class="container-fluid">
                    <form onsubmit="enviar_add('<?= $Administracion['CICLO']; ?>'); return false" id="Add">
                        <div class="row">
