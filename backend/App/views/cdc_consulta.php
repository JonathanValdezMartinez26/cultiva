    ...
    <div class="panel">
        <div class="panel-header" style="padding: 10px;">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group" style="display: flex; flex-direction:column; align-items: center;justify-content: center;height: 100px;padding: 0;margin: 0; color: black; height: 137px; font-size: medium;">
                        <span>Niveles de Score</span>
                        <ul>
                            <li style="list-style:none;">Score menor a 470 = <span style="color: red; font-weight: bold;">Bajo</span></li>
                            <li style="list-style:none;">Score entre 470 y 550 = <span style="color: orange; font-weight: bold;">Moderado</span></li>
                            <li style="list-style:none;">Score entre 550 y 700 = <span style="color: green; font-weight: bold;">Bueno</span></li>
                            <li style="list-style:none;">Score mayor a 700 = <span style="color: blue; font-weight: bold;">Excelente</span></li>
                        </ul>
                    </div>
                </div>
            </div>
